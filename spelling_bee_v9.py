...
def title_banner():
    ...
    print(line_colour_label("pink") + bolden() + "--------------------------------------------\n"
          ...
          line_colour_label("pink") + bolden() + "-----   NYT Spelling Bee word finder   -----\n"
          + reset_text_formatting() +
...
def instructions_and_information():
    ...
    print(line_colour_label("yellow") + italicise() + "If it's your first time here, please read the instructions below:\n\n" + reset_text_formatting()
          + line_colour_label("yellow") + "This tool helps you find the answers to NYT Spelling Bee puzzle.\n"
          + line_colour_label("yellow") + "Please familiarise yourself with the puzzle before using the program here: "
        ...
        "cyan") + "You will " + bolden() + underline() + "receive" + reset_text_formatting() + ":\n"
          + line_colour_label("cyan") + "- a list of words (sorted by length) that you can use for the puzzle\n"
          + line_colour_label("cyan") + "- the amount of time taken to find all the words\n"
...
def valid_letter_input():
    ...
    print("\n" + line_colour_label("yellow") + underline() + italicise() +
          ...
          + line_colour_label("yellow") + "- seven letters only\n"
          + line_colour_label("yellow") + "- no duplicates\n"
          + line_colour_label("yellow") + "- no other characters, but:\n"
          + line_colour_label("yellow") + "- (spaces, capitals and commas are allowed)\n")
    ...
    while not valid_input:
        ...
        if var_count > 1:
            print("\n\n" +
                  ...
                  line_colour_label("red") + "- seven letters only\n" +
                  line_colour_label("red") + "- no duplicates\n" +
                  line_colour_label("red") + "- no other characters, but:\n" +
                  line_colour_label("red") + "- (spaces, capitals and commas are allowed)\n")
        # get letter input from user, and remove commas, leading/trailing spaces and apply lowercase to all characters
        user_input = input(line_colour_label("blue") + "Enter the seven letters, " + underline() + "starting with the must-have letter" + reset_text_formatting() + ": ").replace(" ", "") \
            .replace(",", "").lower()
